#
#  Be sure to run `pod spec lint ArrownockSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of ArrownockSDK in Markdown format.
  ...
  s.homepage     = "https://github.com/myz1104/ArrownockSDK"
